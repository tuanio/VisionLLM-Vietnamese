...
def compare_gt_with_pred(gt, pred, model_name="hiieu/halong_embedding", truncate_dim=64): #matryoshka_dim = 64
    # Khởi tạo model
...
similarity = compare_gt_with_pred(ground_truth, prediction)
print(similarity)